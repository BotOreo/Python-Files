...
def tf(key,value,y):
    ...
    list_tf = {}
    print(key)
    print("This is value of total number of terms in the document - %d" % y)  # Tengok dekat sini Zaimmmm
    print("This is value of terms t appears in a document - %d" % value)  # Tengok dekat sini Zaimmmm
    tf = value/y
