...
sys.argv[1]= "2018-01-09"
sys.argv[2]= "2018-01-10"
sys.argv[3]= "tcs"


start_date = sys.argv[1]  # "2018-01-09"
end_date = sys.argv[2] # "2018-01-10"
consumerKey = "MVxlYWo3CHfveBrak8cXGn7cS"
consumerSecret = "DR7MKOCAaFNIaWid8wHBp90XEllTTEjZOkRLrytkZeCURres8l"
accessToken = "714513048-qEOFE1GxgcbrthNzcUZOW3u78xqq0OwjrHKfmjBh"
accessTokenSecret = "s5GUNJHZAirJXtVzfGBY6XL2jzYHV25BwYOi5COSUvZ9H"
...
def get_tweets(min_faves):
    ...
    return oauth_req(
        'https://api.twitter.com/1.1/search/tweets.json?' + '&q=' + keyword + '&lang=' + lang + '%20since%3A' + start_date + '%20until%3A' + end_date + '%20min_faves%3A' + str(
            min_faves) + '&result_type=mixed&count=100')
...
while (1):
    ...
    print("At request: " + str(req_count) + "  Total Tweets Collected: " + str(len(data)) + " with Min Faves: " + str(
        min_faves))
