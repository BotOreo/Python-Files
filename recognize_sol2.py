...
f.add_arc('1', '2', ('ry') ,('ri')) # 1 -> 2 [a:1
f.add_arc('1', '2', ('va') ,('be')) # 1 -> 2 [a:1
f.add_arc('1', '2', ('c') ,('ku')) # 1 -> 2 [a:1
...
f.add_arc('5', '5', ('ll') ,('ru')) # 4 -> 5[a:1
f.add_arc('5', '5', ('me') ,('bu')) # 4 -> 5[a:1
f.add_arc('5', '5', ('m') ,('mu')) # 4 -> 5[a:1
